	...
	if (isset($_POST['term']) === true) {
		...
		if (isset($_POST['name']) && !empty($_POST['name'])) {
			if (preg_match('/^[A-Za-z\s]+$/', $_POST['name'])) {
				...
				$nameError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
						<strong>lower and upper case and space characters are allow.</strong>
		...
		if (isset($_POST['day']) && !empty($_POST['day'])) {
			...
			$dayError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
					<strong>Please select input.</strong>
					<button type="button" class="close" data-dismiss="alert" aria-label="Close">
					  <span aria-hidden="true">&times;</span>
					</button>
				  </div>';
			...
			if (preg_match($pattern, $_POST['email'])) {
				...
				if (mysqli_num_rows($result) > 0) {
					$emailError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
									<strong>Sorry! this email is already taken.</strong>
									<button type="button" class="close" data-dismiss="alert" aria-label="Close">
									  <span aria-hidden="true">&times;</span>
									</button>
								  </div>';
		...
		if (isset($_POST['city']) && !empty($_POST['city'])) {
			if (preg_match('/^[A-Za-z\s]+$/', $_POST['city'])) {
				...
				$cityError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
									<strong>lowe and upper case and space characters are allow.</strong>
									<button type="button" class="close" data-dismiss="alert" aria-label="Close">
									  <span aria-hidden="true">&times;</span>
									</button>
								  </div>';
		...
		if (isset($_POST['password']) && !empty($_POST['password']) && isset($_POST['password']) && !empty($_POST['c_password']) && !empty($_POST['c_password'])) {
		...
		if (
			...
			&& isset($month) && isset($year) && isset($email) && isset($contact_no) && isset($city) && isset($password)
		) {
      ...
      $password= md5($password);
			...
			<strong>Oops! Something went error.</strong>
			<button type="button" class="close" data-dismiss="alert" aria-label="Close">
			  <span aria-hidden="true">&times;</span>
			</button>
		  </div>';
        ...
        <div class="col-md-6 offset-md-3 form-container">
            ...
            <form class="form-group" action="" method="post" novalidate="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="contact_no"  placeholder="98********" class="form-control" required
                        pattern="^\d{10}$" title="10 numeric characters only" maxlength="10" alue="<?php if (isset($contact_no))
						echo $contact_no; ?>">
